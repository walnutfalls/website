...
const HrefClasses = 'font-medium text-blue-600 dark:text-blue-500 hover:underline'
...
const Demos: React.FC<Props> = ({ }) => {
    ...
    const items = [
        <Item key={0} title='This Site' onClick={() => setSelectedIndex(0)} selected={selectedIndex == 0}>
            Built with React, TailwindCSS, Vite. Source: <GithubHref href={atob('aHR0cHM6Ly9naXRodWIuY29tL3dhbG51dGZhbGxzL2xwCg==')}>Source here</GithubHref>
        </Item>,
        <Item key={1} title='Multiplayer Snake' onClick={() => setSelectedIndex(1)} selected={selectedIndex == 1}>
            ...
            Source <GithubHref href={atob('aHR0cHM6Ly9naXRodWIuY29tL3dhbG51dGZhbGxzL3NuZWtkZWsK')}>Source here</GithubHref>
        ...
        <Item key={3} title='Warigami' onClick={() => setSelectedIndex(3)} selected={selectedIndex == 3}>
            <Paragraph>Grad school project at Digipen. Led team, contributed to core engine systems, memory management, ecs, sound.</Paragraph>
            <Paragraph>
                Much of this engine became my 'grad school engine' which can be found <GithubHref href={atob('aHR0cHM6Ly9naXRodWIuY29tL3dhbG51dGZhbGxzL2NzNTYyX2VuZ2luZQo=')}>here</GithubHref>.
            </Paragraph>
            <div className='my-2'>
                <Video url='warigami.mp4'/>
            </div>
        </Item>,
        <Item key={3} title='Digital Image Processing Coursework' onClick={() => setSelectedIndex(4)} selected={selectedIndex == 4}>
